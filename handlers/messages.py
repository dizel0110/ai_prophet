...
async def cmd_start(message: types.Message):
    ...
    welcome_text = (
        ...
        f"• 🎵 Музыка для массажа — 8 жанров\n"
        f"• 🖼 Анализ фото и видео осанки\n"
        f"• 🎙 Голосовые сообщения (Whisper)\n"
        f"• 🌐 Поиск информации в сети\n\n"
        f"🎹 *Быстрые команды:*\n"
        f"• `/massage` — 🖐 AI-консультация массажного салона\n"
        f"• `/specialist <роль>` — 🧑‍⚕️ создать своего эксперта\n"
        f"• `/help` — полная справка\n\n"
        f"👇 *Выбери действие в меню или просто напиши мне!*"
    )
